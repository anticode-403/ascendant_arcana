...
public class AArcanaAttributes {
    ...
    public static final EntityAttribute DAMAGE_TAKEN = register("ascendant_arcana:generic.damage_taken", new ClampedEntityAttribute("attribute.ascendant_arcana.generic.damage_taken", 1.0d, 0.0d, 100.0d));
